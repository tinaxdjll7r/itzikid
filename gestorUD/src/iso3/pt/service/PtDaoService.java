...
//1) empezar con pantalla de login con user y password. 
//       si el dni es 111 y la ps 111 entonces sacar mensaje ok.
//       si es distinto error
//2) integracion con hibernate
//3) validacion real -> usuario/password
//4) visualizar la lista de asignaturas
